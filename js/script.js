...
const gamesURL = "https://nenorvalls.no/flower-power/gamehub/wp-json/wc/store/v1/products?consumer_key=ck_6131069f7cf8fe34078860b7f32de680257422f1&consumer_secret=cs_81c77c45ce7a85e90c9f21bc157818964c403cc3";
			...
			gamesContainer.innerHTML += `<a href="details.html?id=${game[i].id}" class="card">
											<div class="grid-container">
		   									...
		   									<div class="game-details">
			   									...
			   									<p><span class="index-game-price">${game[i].prices.currency_symbol}${game[i].prices.price}.99</span></p>
		   									</div>
	   									</a>`;
		};
	}
